...
describe('Reminder', () => {
  ...
  it('should remind everyone', async () => {
    ...
    expect(postMessage).toBeCalledWith('to', 'Bonjour <@to> ! Si tu souhaites prendre quelques minutes pour remercier les Sapients qui t\'ont aidé(e) ces dernières semaines, <https://home.publicissapient.fr/cicero|home.publicissapient.fr> est à ta disposition.', [{
      'text': {
        'text': 'Bonjour <@to> ! Si tu souhaites prendre quelques minutes pour remercier les Sapients qui t\'ont aidé(e) ces dernières semaines, <https://home.publicissapient.fr/cicero|home.publicissapient.fr> est à ta disposition.',
        'type': 'mrkdwn'
      }, 'type': 'section'
    }, {
      'elements': [{
